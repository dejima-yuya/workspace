...
(() => {
  var r,
    ...
    t = {
            ...
            class t {
                    ...
                    ? ((this.$el = n(this.options.form)),
                      this.options.container
                        ? ((this.$container = n(this.options.container)),
                          (e = n.isDOMElement(this.$container)
                            ? this.$container
                            : this.$container[0]).getAttribute(
                            this.initializedDataAttr
                          ) ||
                            (e.setAttribute(this.initializedDataAttr, !0),
                            this.render(),
                            this.attachHandlers(),
              ...
              render() {
                ...
                if (
                  ...
                  this.options.width &&
                    ...
                    (r.style.transform = `scale(${this.options.width / e})`)),
                  ("undefined" != typeof navigator && null !== navigator
                    ? navigator.userAgent
                    : void 0) &&
                    -1 !==
                      (p = navigator.userAgent.toLowerCase()).indexOf(
                        "safari"
                      ) &&
                    -1 === p.indexOf("chrome") &&
              ...
              handle(r) {
                return (e) => {
                  var t;
                  return (
                    (t = Array.prototype.slice.call(arguments)).unshift(
                      e.target
                    ),
                    this.handlers[r].apply(this, t)
                  );
                };
              }
              validToggler(r) {
                ...
                return (
                  ...
                  (r, t, a) => {
                    ...
                    return (
                      (n = e(r)),
                      this.toggleValidClass(t, n),
                      this.toggleValidClass(a, n),
                      r
                    );
                  }
                );
              ...
              getCardType() {
                return (
                  Payment.fns.cardType(this.$numberInput[0].value) || "unknown"
                );
              }
            }
            return (
              ...
              (e = function (r, e, t, a) {
                ...
                for (
                  ...
                  b = (0, u[d])(b, r, e);
                for (j = [], i = p = 0, s = e.length; p < s; i = ++p)
                  (f = e[i]),
                    (g = a.fill ? b + t[i].substring(b.length) : b || t[i]),
      ...
      648: (r) => {
        ...
        r.exports = function (r) {
          var o = this;
          if ("function" != typeof o || a.call(o) !== n)
      ...
      452: (r) => {
        ...
        "function" == typeof Symbol && (e = Symbol.prototype.valueOf),
          "function" == typeof BigInt && (t = BigInt.prototype.valueOf);
        var i = function (r) {
            return r != r;
          },
        ...
        (l.a = l.type =
          ...
          (l.within = function (r, e, t) {
            ...
            if (!l.number(r) || !l.number(e) || !l.number(t))
          ...
          (l.primitive = function (r) {
            return (
              !r ||
              !("object" == typeof r || l.object(r) || l.fn(r) || l.array(r))
            );
          }),
          (l.hash = function (r) {
            return (
          ...
          (l.symbol = function (r) {
            return (
              ...
              "[object Symbol]" === o.call(r) &&
              "symbol" == typeof e.call(r)
            );
          }),
          (l.bigint = function (r) {
            return (
              "function" == typeof BigInt &&
              "[object BigInt]" === o.call(r) &&
              "bigint" == typeof t.call(r)
            );
          }),
          (r.exports = l);
      },
              ...
              return (
                ...
                (r.fns = {
                  cardExpiryVal: function (r) {
                    ...
                    return (
                      ...
                      2 === (null != (a = t[1]) ? a.length : void 0) &&
                        /^\d+$/.test(a) &&
                        (a =
                          new Date().getFullYear().toString().slice(0, 2) + a),
                      {
                  ...
                  validateCardNumber: function (r) {
                    ...
                    return (
                      ...
                      !!/^\d+$/.test(r) &&
                        !!(e = n(r)) &&
                        ((t = r.length),
                        D.call(e.length, t) >= 0 && (!1 === e.luhn || m(r)))
                    );
                  },
                  ...
                  cardType: function (r) {
                    var e;
                    return (
                      (r && (null != (e = n(r)) ? e.type : void 0)) || null
                    );
                  },
        ...
        function a(r, a) {
          for (var o = {}, i = [], d = 0; d < r.length; d++) {
            ...
            if (-1 !== f) e[f].references++, e[f].updater(g);
              ...
              var u = n(g, a);
              (a.byIndex = d),
                e.splice(d, 0, { identifier: s, updater: u, references: 1 });
            }
            i.push(s);
          }
          return i;
  ...
  (n.n = (r) => {
    ...
    ((r = n(311)).card = {}),
    (r.card.fn = {}),
    (r.fn.card = function (e) {
      return r.card.fn.construct.apply(this, e);
    }),
    r.fn.extend({
      card: function (t, ...a) {
        return this.each(function () {
          var n, o;
          if (
            ((o = (n = r(this)).data("card")) ||
              (r.each(t, (r, e) => {
                if (e instanceof jQuery) return (t[r] = e[0]);
              }),
              (t.form = this),
              n.data("card", (o = new e(t)))),
            "string" == typeof t)
          )
